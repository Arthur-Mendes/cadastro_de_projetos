          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Selecionar Tipo de Geração</h3>
              </div>
            </div>
                    ...
                    <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                          ...
                          <select name="tipo_geracao" class="form-control" id="tipo_geracao"  placeholder="Campo Obrigatório">
                                <option value="1">Minigeração</option>
...
function tipogeracao (){
  if (document.getElementById('tipo_geracao').value == 1)
  {
    window.location.href='CL_Criacao_Projeto_Mini.php';
  }
  else if (document.getElementById('tipo_geracao').value == 2)
    {
    window.location.href='CL_Criacao_Projeto_Micro1.php';
  }
   else if (document.getElementById('tipo_geracao').value == 3)
    {
    window.location.href='CL_Criacao_Projeto_Micro2.php';
  }
}
