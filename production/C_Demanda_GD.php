                    ...
                    <table id="Tabela" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php 
                          ...
                          $sql = $pdo->prepare("SELECT * FROM geracao_distribuida");
                          $sql->execute();
                          ...
                          if($sql->rowCount() > 0) {
                            foreach ($sql->fetchAll() as $value) {
                              ...
                              echo "<tr>";
                                  ...
                                  echo "<td><a href='C_Chat.php?de=$usuario&para=$protocolo'><span class='fa fa-comments-o' ></span></a></td>";
                                  echo "<td><a href='#' onclick='teste(GD-188-2018);'><span class='fa fa-check-square-o' ></span></a></td>";
