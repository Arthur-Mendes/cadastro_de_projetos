              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="PJ_Cadastrar_Historico2.php">

                      <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                        <div class="form-group">
                          <label class="control-label col-md-6 col-sm-6 col-xs-12" for="processo">Informe quantos históricos deseja inserir.
                          </label>
                          <div class="col-md-1 col-sm-1 col-xs-12">
                            <input type="text" name="numero" id="numero" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                      </div>
