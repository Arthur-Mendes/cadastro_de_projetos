                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php 
                          ...
                          $sql = $pdo->prepare("SELECT * FROM demanda_projetos");
                          $sql->execute();
                          ...
                          if($sql->rowCount() > 0) {
                            foreach ($sql->fetchAll() as $value) {
                              ...
                              echo "<tr>";
                                  ...
                                  echo "<td><a href='PJ_Editar_Projetos.php?processo=$processo'><span class='fa fa-pencil' ></span></a></td>";
                                  echo "<td>$processo</td>";
                                  ...
                                  echo "<td>$status</td>";
                                  echo "<td>$viabilidade_tecnica</td>";
