...
require 'Config/Config4.php';
  ...
  $sql = $pdo->prepare("INSERT INTO projetos (processo, ordem, descricao, tecnico, interessado, uc, cpf, cidade, bairro, coordenada_x, coordenada_y, data_entrada, data_prevista, demanda_prevista, observacao, viabilidade_tecnica, status, pontos, odi) VALUES (:processo, :ordem, :descricao, :tecnico, :interessado, :uc, :cpf, :cidade, :bairro, :coordenada_x, :coordenada_y, :data_entrada, :data_prevista, :demanda_prevista, :observacao, :viabilidade_tecnica, 'Em Análise', :pontos, :odi)");
