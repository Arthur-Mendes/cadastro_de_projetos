          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Técnicos</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <a href='Editar_Tecnicos_PJ.php?key=$key'></a>
                    <table id="Tabela" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                          ...
                          $querySelect = $link->query("SELECT * FROM tecnicos");
                          while($value = $querySelect->fetch_assoc()):
                              ...
                              $id = $value['id'];
                                ...
                                echo "<tr>";
                                  echo "<td><a href='PJ_Editar_Tecnicos.php?id=$id'><span class='fa fa-pencil' ></span></a></td><td>$nome</td><td>$logradouro</td><td>$fone1</td><td>$email1</td><td>$crea</td>";
                                echo "</tr>";
                          endwhile;
                        ?>
                      </tbody>
        ...
        $(document).ready(function() {
            ...
            $('#Tabela').DataTable( {
                ...
                "language": {
                    ...
                    "zeroRecords": "Nenhum técnico encontrado - desculpe",
